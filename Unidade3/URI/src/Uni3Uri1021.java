...
//__ Processos:
notaCem = numInteiro / 100;
        notaCinquenta = (numInteiro % 100) / 50;
        notaVinte = ((numInteiro % 100) % 50) / 20;
        notaDez = (((numInteiro % 100) % 50) % 20) / 10;
        notCinco = ((((numInteiro % 100) % 50) % 20) % 10) / 5;
        notaDois = (((((numInteiro % 100) % 50) % 20) % 10) % 5) / 2;
